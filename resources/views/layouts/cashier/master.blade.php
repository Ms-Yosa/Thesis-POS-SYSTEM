    ...
    <div id="main-wrapper">
        <!-- Nav header start -->
            ...
            <div class="nav-header">
                <div>
                   <strong> <span class="navbar-brand nav-label first" style="color:black;text-align:center;padding-left:39px">Point of Sale System <br> <small>Draft Interface</small> </span></strong>
                </div>
               
                    <div class="nav-control" >
               
                    <div class="hamburger">
                        <img class="logo-abbr" style="border-radius:25px; border: 2px solid #FD6300;" src="{{ URL::to('Assets/Icons/logo.svg') }}" alt="">
